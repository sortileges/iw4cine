...
load_defaults()
{
    ...
    level.BOT_AUTOCLEAR             = false;    // [true/false] - Clears all bodies when a bot spawns
    ...
    level.ACTOR_SHOW_KILLFEED       = true;     // [true/false] - Enable fake killfeed when killing an actor
}